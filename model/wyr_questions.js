...
function randomWYRQuestion() {
    const randomIndex = Math.floor(Math.random() * questions.length)//grabs a random number to be used for index
    const randomQuestion = questions[randomIndex]
    return randomQuestion
}

module.exports = randomWYRQuestion //give access to this function to other files